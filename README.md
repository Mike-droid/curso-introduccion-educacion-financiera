# Curso de Introducción a la Educación Financiera
...
> Pocas piezas simples, muchas transacciones que se repiten una y otra vez, de manera infinita, y que son impulsadas y movidas por la naturaleza humana. - Ray Dalio

#### Economía básica

La economía es la suma de transacciones movidas por la naturaleza humana. `Economía = Naturaleza humana -> Instituciones y/o Personas`.

#### Transacciones, mercado y crédito

- Transacción: un comprador, canjea dinero o crédito a un vendedor por mercancías, servicios o activos financieros. **Para efectos FINANCIEROS, el crédito y el dinero son lo mismo**. El crédito se gasta como el dinero. Aunque no es lo mismo. Para la activación de la economía, sí lo es.
¿Quienes participan en la transacción? Empresas, Gobiernos y Bancos.

**Ecuación de la transacción: `Dinero + Crédito = Gasto Total`**

- Mercado: Es toda transacción de compra y venta que se realizan del mismo producto o servicio.
- Crédito: Está formado por dos integrantes
  - Prestadores/Acreedores: Buscar convertir su dinero en más dinero. Es quien presta el dinero.
  - Prestatario/Deudor: Es quien recibe el dinero. El prestatario quiere, busca, algo que no puede pagar.

En el crédito, tenemos que:

El prestatario o deudor:

- Se compromete a pagar en el tiempo e intereses acordados.
- Deberá tener un aval (una tercera persona que hace de garantía para el pago de una obligación si la persona (deudor) no pudiera hacerse cargo).
...
*Dato importante*: El *interés* es el pago que debes de realizar porque te prestaron dinero.

### Tasa de interés y la importancia del crédito

El crédito está formado por:

Capital (La suma que solicitamos) + Interés (Lo que vamos a pagar por prestarnos el capital)

#### El Banco Central

- El Banco Central de cada país es quién determina de cuánto será la tasa de %.
- Es una herramienta para conservar el poder adquisitivo de la moneda.

- Cuando la tasa de interés es baja, hay más préstamos porque son baratos, esto causa mucho consumo de crédito.
- Cuando la tasa de interés es alta, hay menos préstamos porque son más caro, esto causa poco consumo de crédito.

El crédito = **Deuda** (Para el que pidió el dinero).

Cuando tú pides un crédito y te lo dan, tú como prestatario tienes ahora una ***DEUDA***, que para el prestador es ahora un ***ACTIVO***.

#### ¿Por qué es tan importante el crédito?

El gasto de uno, es el ingreso de otro. Y, si el gasto es lo que mueve a la economía, entonces tenemos mucho "dinero" activando a la economía.

Recuerda, si eres buen consumidor, entonces el banco te dará mejores y más créditos.

Películas recomendadas:

- The big short (película)
- Margin Call (parodia pero aprendes)
- Inside Job (documental)
- Capitalism: a love story

### Banco Central

Empecemos con mencionar la importancia e impacto de un Banco Central a una nación.

Como vimos en el comportamiento de la deuda, el Banco Central es un jugador sumamente decisivo para el aparente, a veces, bienestar financiero de un país.

Tiene un gran peso de responsabilidad, ya que ellos regulan las reglas (políticas monetarias) de todo un país o región.

Que no existan fuertes inflaciones y deflaciones muy fuertes; controlar el valor.

Un Banco Central tiene el siguiente mandato o finalidad: Cuidar el valor de la moneda nacional; que no pierda su valor, es decir, que te siga alcanzando con la misma cantidad de dinero, para las mismas cosas de consumo, en un cierto periodo de tiempo.

Lo hace con las siguientes herramientas de la política monetaria:

- Tasa de interés (la que más nos interesa). Como ya vimos en clases pasadas, el Banco Central puede terminar en subir o bajar las tasas de así considerarlo.
...
- Velar por la Base Monetaria.

Dinero en efectivo + los depósitos bancarios (reservas)

- Estas reservas, servirán para generar más dinero, ya que, es el dinero que prestan de un prestatario, o bien, lo invierten.

Punto interesante: estas reservas, están tabuladas, es decir, en teoría, los bancos solo podrán usar un porcentaje de estas reservas para sus propios usos.
...
¡Que exista dinero circulante!

Es decir, el dinero tanto digital como físico que pasa por nuestras manos.

La función de este curso, es invitarte a la reflexión del sistema, entenderlo y cuestionarlo.

Dicho lo anterior, te comparto una característica que me parece bastante interesante:

Los Bancos Centrales pueden ser autónomos e independientes del gobierno.

En algunos países, si trabajan de manera conjunta.

Algunos, hasta su propio gobierno tienen.

Esta independencia está supeditada al marco legal que rige al Banco Central. Lo interesante es que pueden o no participar en conjunto con el gobierno federal de cada país.

Por ejemplo, la Reserva Federal de Estados Unidos (que es su Banco Central), está dirigido por una junta de 7 miembros que son nombrados en periodos de cada 14 años ¡Wow!
De esta forma, intentan aislar las influencias políticas de los gobiernos que tienen necesidades a corto plazo, dado que sus mandatos son de 4 años o, por ejemplo, la presión de partidos políticos que utilizan promesas de campañas basadas en “mejoras” de las políticas monetarias, como una manipulación de las tasas de interés para dar la sensación de holgura económica y un falso bienestar financiero (recuerda, que esto puede ser perjudicial para el comportamiento de la inflación).

Recordarás lo importante de no solo ver una muestra del ciclo económico, sino el ciclo completo.

Como verás, esto es un punto que da pie al debate.
...
El Banco Central no desea demasiada inflación porque causa problemas. Al ver que los precios suben, el banco sube las tasas de interés con tasas de interés más altas, menos personas pueden permitirse tomar préstamos y el coste de las deudas existentes sube.

Si la recesión se torna demasiado grave y la inflación ya no es un problema, el Banco Central bajará las tasas de interés para que todo vuelva a remontar con tasas de interés bajas

El Banco Central, en esencia, presta dinero al gobierno, permitiéndole mantener un déficit y aumentar el gasto en bienes y servicios mediante sus programas de incentivos y de seguros de paro.

¿Quieres profundizar en la importancia del Banco Central? Te recomiendo la película “Money for nothing: Inside of the Federal Reserve”.

### Ciclos económicos

El ciclo económico es el conjunto de fases por las que pasa la actividad económica.
...
- Depresión: Se extiende la recesión continuada. Se desconoce cuando será la recuperación. ‼⚠❌
- Recuperación: La economía pasa de estar estancada a tener una pequeña recuperación. ↗

#### Productividad

En una transacción hay que dar algo para obtener algo, por tanto, cuándo obtenemos depende de cuántos producimos.

Factores que influyen en la productividad: experiencia, empuje, creatividad y oportunidades.
...
|Consumo lo que puedo pagar|Consumo aunque no tenga dinero|
|Crecimiento lento|Crecimiento acelerado|

[Reloj de los ciclos económicos de México](https://www.inegi.org.mx/app/reloj/)

### Comportamiento vía deuda

Gastas más de lo que produces y tu "yo" del futuro lo tendrá que pagar.

### Comportamiento vía productividad

Ingreso -> Gasto -> Producitividad = Crecimiento
...
Hablemos ahora del ciclo de deudas a largo plazo.

Ahora bien, no me malinterpreten, el crédito no es necesariamente algo malo que solo causa ciclos. Es malo cuando financia un exceso de consumo que no puede reembolsar. Sin embargo, es bueno cuando asigna recursos con eficacia y produce ingresos que nos permiten devolver la deuda
